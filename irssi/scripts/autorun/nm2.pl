...
# put the desired indicator(s) between the appropriate ","
#
# /format neat_style      , , , , , , , ,
#                        î î î î î î î î î
...
#                           î î î î î
# p: pad                    | | | | `-before message
# t: truncate indicator     | | | `-after nick
#                           | | `-before nick
#                           | `-before action
#                           `-none
#
...
Irssi::expando_create('nickalign', \&expando_nickalign, {
    ...
    'message irc action'     => 'none',
    'message irc own_action' => 'none',
   });
...
sub update_formats {
    ...
    @astyle = map { y/ptm//cd; $_ } split /,/, $S{action_style};
